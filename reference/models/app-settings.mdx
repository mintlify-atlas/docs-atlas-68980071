---
title: "AppSettings Model Reference"
sidebarTitle: "AppSettings"
description: "Complete reference for the AppSettings class and nested AppearanceSettings and PinnedWindowId types that control all BetterWinTab configuration."
---
