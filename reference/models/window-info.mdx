---
title: "WindowInfo Model Reference"
sidebarTitle: "WindowInfo"
description: "Reference for the WindowInfo class that represents an open Windows window, including handle, process, title, class, virtual desktop metadata, and pin state."
---
