---
title: "Get Started with BetterWinTab in 5 Minutes"
...
<CardGroup cols={2}>
  <Card title="Smart Folders in Depth" icon="folder-open" href="/introduction">
    Learn about all folder types, rule options, and how manual and smart folders interact.
  </Card>
  <Card title="Themes & Customization" icon="palette" href="/introduction">
