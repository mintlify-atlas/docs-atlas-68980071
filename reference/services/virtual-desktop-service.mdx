---
title: "VirtualDesktopService — Virtual Desktop COM API Reference"
sidebarTitle: "VirtualDesktopService"
description: "VirtualDesktopService wraps IVirtualDesktopManager to enrich BetterWinTab windows with desktop GUID, number, name, and current-desktop status."
---
