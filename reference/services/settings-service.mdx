---
title: "SettingsService — Settings Persistence API Reference"
sidebarTitle: "SettingsService"
description: "SettingsService persists BetterWinTab settings to JSON in %APPDATA% and manages the Windows startup registry entry. Covers Load, Save, and run-at-startup."
---
